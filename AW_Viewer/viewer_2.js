...
function preloadImages () {
    ...
    data.img.player[0] = "img/playerb.blu.png";

    data.img.player[1] = "img/playerb.bla.png";

    data.img.player[2] = "img/playerb.red.png";

    data.img.player[3] = "img/playerb.yel.png";
}
...
function writeGameState () {
    ...
    for (var i = 0; i < data.nb_players; i++) {
        scoreboard += "<span class='score'>"
            + "<div style='display:inline-block; margin-top: 5px; width:60px; height:20px; background-image: url(\""+data.img.player[i]+"\");'></div>"
